...
원한다면 미션 #3에서 만든 반가산기를 `07_half_adder.dig`로 저장해 부품으로 사용할 수 있습니다. 이전 회로의 사용은 선택입니다.""",
     8),
...
원한다면 미션 #3의 `07_half_adder.dig`와 미션 #4의 `08_full_adder.dig`를 부품으로 사용할 수 있습니다. 이전 회로의 사용은 선택입니다.""",
     64),
...
원한다면 미션 #4에서 만든 전가산기를 `08_full_adder.dig`로 저장해 부품으로 사용할 수 있습니다. 이전 회로의 사용은 선택입니다.""",
     8),
...
원한다면 Part A-1에서 만든 판정 회로를 `12_at_least_one.dig`로 저장해 부품으로 사용할 수 있습니다. 이전 회로의 사용은 선택입니다.""",
     64),
